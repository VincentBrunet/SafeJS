...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c27 = peg$otherExpectation("ClassExpression"),
      peg$c28 = "static",
      peg$c29 = peg$literalExpectation("static", false),
      peg$c30 = function(isStatic, content) {
          return ast({
              ast_type: "Statement",
              ast_title: "_",
              ast_childs: {
      ...
      peg$c31 = peg$otherExpectation("Variable"),
      peg$c32 = "var",
      peg$c33 = peg$literalExpectation("var", false),
      peg$c34 = "let",
      peg$c35 = peg$literalExpectation("let", false),
      peg$c36 = "=",
      peg$c37 = peg$literalExpectation("=", false),
      peg$c38 = function(mode, name, type, value) {
          var val;
          if (value) {
              val = value[3];
          }
      ...
      peg$c41 = function(condition, block) {
          return ast({
              ast_type: "If",
              ast_childs: {
      ...
      peg$c44 = function(condition, block) {
          return ast({
              ast_type: "ElseIf",
              ast_childs: {
                  Expression: condition,
      ...
      peg$c46 = peg$otherExpectation("Condition"),
      peg$c47 = function(p_if, p_elseIf, p_else) {
          var condIf = p_if;
          var condElseIfs = [];
          var condElse;
      ...
      peg$c50 = function(condition, block) {
          return ast({
              ast_type: "While",
              ast_childs: {
                  Condition: condition,
      ...
      peg$c53 = "in",
      peg$c54 = peg$literalExpectation("in", false),
      peg$c55 = function(name, expression, block) {
          return ast({
              ast_type: "For",
              ast_childs: {
                  Name: name,
      ...
      peg$c56 = peg$otherExpectation("Loop"),
      peg$c57 = function(loop) {
          return loop;
      },
      peg$c58 = peg$otherExpectation("Return"),
      peg$c59 = "return",
      peg$c60 = peg$literalExpectation("return", false),
      ...
      peg$c62 = peg$otherExpectation("Resolve"),
      peg$c63 = "resolve",
      peg$c64 = peg$literalExpectation("resolve", false),
      ...
      peg$c66 = peg$otherExpectation("Throw"),
      peg$c67 = "throw",
      peg$c68 = peg$literalExpectation("throw", false),
      ...
      peg$c75 = peg$otherExpectation("Try-Catch"),
      peg$c76 = "try",
      peg$c77 = peg$literalExpectation("try", false),
      peg$c78 = "finally",
      peg$c79 = peg$literalExpectation("finally", false),
      peg$c80 = function(tryBlock, catches, finallyB) {
          var finallyBlock;
          if (finallyB) {
      ...
      peg$c81 = peg$otherExpectation("Break"),
      peg$c82 = "break",
      peg$c83 = peg$literalExpectation("break", false),
      peg$c84 = function() {
          return ast({
              ast_type: "Break",
              ast_childs: {
      ...
      peg$c85 = peg$otherExpectation("Continue"),
      peg$c86 = "continue",
      peg$c87 = peg$literalExpectation("continue", false),
      peg$c88 = function() {
          return ast({
              ast_type: "Continue",
              ast_childs: {
      ...
      peg$c89 = peg$otherExpectation("Async"),
      peg$c90 = "async",
      peg$c91 = peg$literalExpectation("async", false),
      peg$c92 = "@",
      peg$c93 = peg$literalExpectation("@", false),
      peg$c94 = function(type, block) {
          return ast({
              ast_type: "Async",
              ast_title: "async",
              ast_childs: {
      ...
      peg$c95 = peg$otherExpectation("Function"),
      peg$c96 = "fn",
      peg$c97 = peg$literalExpectation("fn", false),
      peg$c98 = "function",
      peg$c99 = peg$literalExpectation("function", false),
      peg$c100 = function(p_name, p_type, params, block) {
          var name;
          if (p_name) {
              name = p_name[1];
          }
      ...
      peg$c101 = peg$otherExpectation("Function Params"),
      peg$c102 = ",",
      peg$c103 = peg$literalExpectation(",", false),
      peg$c104 = ")",
      peg$c105 = peg$literalExpectation(")", false),
      peg$c106 = function(params, lastParam) {
          var list = [];
      ...
      peg$c109 = function(name, type, p_variadic) {
          var variadic = false;
          if (p_variadic) {
              variadic = true;
          }
      ...
      peg$c110 = peg$otherExpectation("Litteral"),
      ...
      peg$c112 = peg$otherExpectation("Operation"),
      peg$c113 = "-=",
      ...
      peg$c189 = "typeof",
      peg$c190 = peg$literalExpectation("typeof", false),
      peg$c191 = "void",
      peg$c192 = peg$literalExpectation("void", false),
      peg$c193 = "delete",
      peg$c194 = peg$literalExpectation("delete", false),
      peg$c195 = function(heads, tail) {
          if (heads.length <= 0) {
              return tail;
          }
          heads.reverse();
      ...
      peg$c197 = function(params, lastParam) {
          var elements = [];
          params.forEach(function (param) {
      ...
      peg$c208 = function(expression, p_params) {
          var params;
          if (p_params) {
              params = p_params[3];
          }
      ...
      peg$c211 = function(types, lastType) {
          var _types = [];
      ...
      peg$c212 = function(name, p_templates) {
          var _templates;
          if (p_templates) {
      ...
      peg$c213 = function(types, lastType) {
          var _types = [];
          types.forEach(function (type) {
              _types.push(type[0]);
          })
      ...
      peg$c219 = peg$otherExpectation("Type"),
      peg$c220 = function(content) {
          return {
              ast_type: "Type",
              ast_childs: {
                  Content: content,
      ...
      peg$c222 = peg$otherExpectation("Array"),
      peg$c223 = function(values, lastValue) {
          var elements = [];
      ...
      peg$c224 = peg$otherExpectation("Dictionary"),
      peg$c225 = function(values, lastValue) {
          var elements = [];
          values.forEach(function (value) {
              elements.push(value[1]);
          });
      ...
      peg$c227 = peg$otherExpectation("Tuple"),
      peg$c228 = function(values, lastValue) {
          var elements = [];
          values.forEach(function (value) {
              elements.push(value[1]);
          });
      ...
      peg$c235 = peg$otherExpectation("Number"),
      peg$c236 = /^[0-9]/,
      peg$c237 = peg$classExpectation([["0", "9"]], false, false),
      peg$c238 = function(it, dc) {
          var value = it.join("");
          if (dc) {
              value += dc;
          }
      ...
      peg$c246 = peg$otherExpectation("String"),
      peg$c247 = function(str) {
          return str;
      },
      peg$c248 = peg$otherExpectation("Identifier"),
      peg$c249 = /^[$A-Za-z0-9_]/,
      peg$c250 = peg$classExpectation(["$", ["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false),
      peg$c251 = function(i) {
          var value = i.join("");
          return ast({
              ast_type: "Identifier",
      ...
      peg$c268 = "\0",
      peg$c269 = peg$literalExpectation("\0", false),
      peg$c270 = function(_array) {
              _array.splice(0, _array.length);
              return true;
          },
      peg$c271 = function(_array, c) {
      ...
      peg$c272 = function(_array, content) {
          var value = content;
          return ast({
      ...
      peg$c274 = peg$otherExpectation("Null"),
      peg$c275 = "null",
      peg$c276 = peg$literalExpectation("null", false),
      peg$c277 = function() {
          return ast({
              ast_type: "Null",
          });
      },
      peg$c278 = peg$otherExpectation("Undefined"),
      peg$c279 = "undefined",
      peg$c280 = peg$literalExpectation("undefined", false),
      peg$c281 = function() {
          return ast({
              ast_type: "Undefined",
          });
